...
- **Freigaben**: Auf den Power-Eingang einer [Clock](../signal/clock.md)
  oder ein [And](../logic/and.md)-Gatter gelegt, wird der Switch zum
...
- **Kurze Signale statt Zustand** liefert der [Button](button.md) — er ist
  die Klingel, der Switch der Lichtschalter.

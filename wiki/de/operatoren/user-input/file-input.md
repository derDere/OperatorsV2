...
Flanke** (siehe
[Flanken und Takt](../../grundlagen/flanken-und-takt.md)) —, liest der
Baustein das nächste Byte.
...
- **Daten als Programm**: Eigene Dateien als Abspiel-Listen, Melodien
  oder Befehlsfolgen — die Datei wirkt dann wie ein **ROM**: ein fester
  Speicher, aus dem die Schaltung nur lesen kann. `R` spult zurück an
  den Anfang.

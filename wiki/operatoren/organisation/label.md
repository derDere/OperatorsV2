...
[Comment](comment.md) auf der Zeichenfläche klebt, erscheint das Label als
Text zwischen den Bedienelementen rechts — als Überschrift, Einheit oder
Trennzeichen. Schriftart, Größe und Farben sind frei wählbar; mit einem
Eintrag im Feld **Href** wird der Text sogar zum anklickbaren Link (er
öffnet in einem neuen Tab).

Auf der Zeichenfläche zeigt sich das Label bewusst blass — es ist kein
Rechen-Baustein, sondern Dekoration mit Aufgabe.
...
- **Anzeige-Deko**: Im Uhren-Beispiel *clock* (📚-Examples-Menü im
  Editor) ist der blinkende Doppelpunkt zwischen den Ziffern ein
  großgestelltes Label.
